...
array1 = pickload("E:/3Yr/ruta_CN.plk")
...
pickle.dump(List2, open('./data1_uno.plk', 'wb')) #guardo las imagenes adecuadas y seleccionadas
pickle.dump(rut, open('./rutas1_uno.plk', 'wb')) #gurardo la ruta para en un futuro juntarla en un excel con cada fila de imagen y mantener un orden
